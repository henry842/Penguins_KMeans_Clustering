...
Unsupervised learning, clustering and exploratory analysis. This project was organized as a portfolio-ready case study: it explains the objective, the analytical path, the visual evidence and the practical interpretation behind the result.

Main objective: Segment penguin observations with K-Means and interpret natural groups from biological measurements.

**PT-BR**

Aprendizado nao supervisionado, clusterizacao e analise exploratoria. Este projeto foi organizado como um estudo de caso pronto para portfolio: explica o objetivo, o caminho analitico, as evidencias visuais e a interpretacao pratica por tras do resultado.

Objetivo principal: Segmentar observacoes de pinguins com K-Means e interpretar grupos naturais a partir de medidas biologicas.
